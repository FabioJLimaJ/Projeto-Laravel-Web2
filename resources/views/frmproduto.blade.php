    ...
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
      <form action="/addproduto" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-6">
          ...
          <div class="mt-1">
            <input class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required="" autocomplete="email" type="number" name="preco" id="preco">
          </div>
        </div>
        ...
        <div class="mt-6">
          ...
          <div class="mt-1">
            <input class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required="" autocomplete="current-password" type="number" name="quantidade" id="quantidade">
          </div>
        </div>
